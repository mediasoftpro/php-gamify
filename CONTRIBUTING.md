...
```bash
$ git clone --recursive git@github.com:mediasoftpro/blogengine.git blogengine
```

This will clone your fork to your current path in a directory named blogengine.
...
You should also set up the upstream repository. This will allow you to take changes from the "master" repository and merge them into your local clone and then push them to your GitHub fork:
    ...
    $ cd blogengine
    $ git remote add upstream git@github.com/mediasoftpro/blogengine.git
    $ git fetch upstream
