...
"use strict";
var gamifyapp = angular.module('gamifyapp', ['ngRoute', 'httpServices', 'programServices', 'ng.shims.placeholder'])
...
.controller('manageController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    ...
    function loadUserBadges() {
        $scope.showLoader = true;
        var url = apiPath + "simulate/load_user_badges.php";
        gamifyHTTP.actionProcess(url, [{
            userid: UserID,
            type: $scope.type,
            loadall: true,
    ...
    $scope.award = function (_id, _icon) {
        ...
        gamifyHTTP.actionProcess(url, [{ userid: UserID, badge_id: _id }])
...
.controller('levelsController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    ...
    function loadUserLevel() {
        $scope.showLoader = true;
        var url = apiPath + "simulate/load_user_levels.php";
        gamifyHTTP.actionProcess(url, [{
            userid: UserID,
            loadall: true,
            order: "userid desc"
