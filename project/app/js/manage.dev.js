...
.controller('manageController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    ...
    function loadBadges(categoryid) {
        ...
        var url = apiPath + "manage/load_ga_badges.php";
    ...
    $scope.dRrecord = function (_id, _icon) {
        ...
        if (r == true) {
            $scope.showLoader = true;
            var url = apiPath + "manage/remove/badge.php";
            gamifyHTTP.actionProcess(url, [{ id: _id, icon: _icon }])
            .success(removeSuccess)
            .error(loadError);
        }
    };

    var url = apiPath + "manage/load_ga_categories.php";
    gamifyHTTP.actionProcess(url, [{
        type: $scope.type,
        loadall: true,
        order: "priority desc, id desc"
...
.controller('rewardsController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
...
.controller('levelsController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
...
.controller('pointsController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
...
.controller('creditsController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
...
.controller('packagesController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
...
.controller('gencodeController', ['$scope', '$routeParams', '$location', 'gamifyHTTP', 'localService', function ($scope, $routeParams, $location, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.message = "";
    $scope.Data = [];
...
.controller('showcodeController', ['$scope', '$routeParams', '$location', 'gamifyHTTP', 'localService', function ($scope, $routeParams, $location, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.selectedID = 0;
    $scope.message = "";
...
.controller('uploadavatorController', ['$scope', '$routeParams', '$location', 'gamifyHTTP', 'localService', function ($scope, $routeParams, $location, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    ...
    $scope.selectedIndex = $scope.type - 1;
    // uploader settings
    $scope.handlerpath = apiPath + "upload/upload.php";
    ...
    $scope.photoname = ""; // name of photo to display
    $scope.defaultphoto = defaultimagePath;
    $scope.updatehandler = apiPath + "upload/updatephoto.php"; // used to update photo info in database
    $scope.removehandler = apiPath + "upload/removephoto.php"; // used to remove previous photo from directory if current photo uploaded and record updated successfully in database
...
.controller('addbadgeController', ['$scope', '$routeParams', '$location', 'gamifyHTTP', 'localService', function ($scope, $routeParams, $location, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.Data = [];
    $scope.message = "";
    ...
    $scope.addBadge = function () {
        ...
        $scope.showLoader = true;
        var url = apiPath + "manage/add/badge.php";
        gamifyHTTP.actionProcess(url, $scope.badge)
...
.controller('associaterewardController', ['$scope', '$routeParams', 'gamifyHTTP', 'localService', function ($scope, $routeParams, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.Data = [];
    $scope.LevelData = [];
    ...
    function loadLevelAssosiates() {
        $scope.showLoader = true;
        var url = apiPath + "manage/load_ga_level_associate.php";
        gamifyHTTP.actionProcess(url, [{
            levelid: _id
        }])
    ...
    $scope.addLevel = function () {
        ...
        gamifyHTTP.actionProcess(url, _data)
        .success(actionSuccess)
        .error(loadError);
    };
}])
.controller('managecategoryController', ['$scope', '$routeParams', 'gamifyHTTP', 'localService', function ($scope, $routeParams, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.selectedIndex = 0;
    $scope.message = "";
    ...
    $scope.dRrecord = function (_id) {
        ...
        if (r == true) {
            $scope.showLoader = true;
            var url = apiPath + "manage/remove/category.php";
            gamifyHTTP.actionProcess(url, [{ id: _id }])
            .success(removeSuccess)
            .error(loadError);
        }
...
.controller('addcategoryController', ['$scope', '$routeParams', 'gamifyHTTP', 'localService', function ($scope, $routeParams, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.selectedIndex = 0;
    $scope.Data = [];
    ...
    $scope.addCategory = function () {
        $scope.showLoader = true;
        var url = apiPath + "manage/add/category.php";
        gamifyHTTP.actionProcess(url, $scope.category)
        .success(actionSuccess)
        .error(actionError);
    };
...
.controller('eventsController', ['$scope', 'gamifyHTTP', 'localService', function ($scope, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.message = "";
    $scope.type = 7; // events
...
.controller('addeventController', ['$scope', '$routeParams', '$location', 'gamifyHTTP', 'localService', function ($scope, $routeParams, $location, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.Data = [];
    $scope.message = "";
    ...
    $scope.addEvent = function () {
        ...
        gamifyHTTP.actionProcess(url, $scope.event)
        .success(actionSuccess)
        .error(actionError);
    };
...
.controller('associateeventController', ['$scope', '$routeParams', 'gamifyHTTP', 'localService', function ($scope, $routeParams, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.Data = [];
    $scope.EventData = [];
...
.controller('showeventcodeController', ['$scope', '$routeParams', '$location', 'gamifyHTTP', 'localService', function ($scope, $routeParams, $location, gamifyHTTP, localService) {
    $scope.Nav = localService.getNav();
    $scope.NavOptions = localService.getNavOptions();
    $scope.selectedID = 0;
    $scope.EventData = [];
...
programServices.factory('localService', ['$http', 'gamifyHTTP',
   function ($http, gamifyHTTP) {
       ...
       return {
           ...
           AddQuestion: function (obj) {
               ...
               gamifyHTTP.actionProcess(url, obj)
                .success(actionSuccess)
                .error(actionError);
           }
       };
...
httpServices.factory('gamifyHTTP', ['$http',
function ($http) {
    return {
