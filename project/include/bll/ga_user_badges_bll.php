...
class ga_user_badges_bll {

   
    private $tableName = "ga_user_badges";
    ...
    function fetch_records($entity, $queryonly = false)
	{
        ...
        if($entity->fields == "")
		   $fields = "*"; // default fields
	    $query = "select " . $fields . " from " . $this->tableName . " as u inner join ga_badges as g on g.id=u.badge_id " . $logic;
